    ...
    <div className='relative flex flex-row gap-4 items-center' ref={dropdownRef}>
      ...
      {dropdownOpen && (
        <div className='z-10 absolute right-0 top-14 mt-2 mt-2 w-48 bg-white rounded-md shadow-lg py-2'>
          ...
          <a
            href='#'
            className='flex flex-row items-center gap-2 border-b rounded-md mx-2 border-gray-200 px-2 block py-1 text-gray-800 hover:bg-gray-200'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 20 20'
          ...
          <a
            href='#'
            className='flex flex-row items-center gap-2 rounded-md mx-2 px-2 block py-1 text-gray-800 hover:bg-gray-200'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 20 20'
