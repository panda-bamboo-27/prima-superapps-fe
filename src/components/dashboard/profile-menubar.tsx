    ...
    return (
        ...
        {dropdownOpen && (
            <div className="absolute right-0 top-14 mt-2 mt-2 w-48 bg-white rounded-md shadow-lg py-2">
                <p className="text-center font-bold border-b px-2 py-1 hover:text-gray-900 text-gray-800 block md:hidden ">Arisal</p>
                <a href="#" className="flex flex-row items-center gap-2 border-b rounded-md mx-2 border-gray-200 px-2 block py-1 text-gray-800 hover:bg-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
                ...
                <a href="#" className="flex flex-row items-center gap-2 rounded-md mx-2 px-2 block py-1 text-gray-800 hover:bg-gray-200">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
